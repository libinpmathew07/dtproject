		...
		<form id="login-form" name="formLogin" action="${loginUrl}"  method="post" class="text-left">
			...
			<div class="main-login-form">
				<div class="login-group">
					...
					<div>
					 <center><h3 class="well" style="font-family: cursive;font-style: italic;color:maroon">LogIn</h3></center></div>
			...
			<center>	
			<input type="submit" name="submit"  class="btn btn-primary" style="font-family:cursive"/>
			</center>
			</div>
